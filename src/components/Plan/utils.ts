import { TransformMatrix, ReferencePoint, SvgParsedData, Point } from '../../types';

// firstly defined
const TLS_0: Point = { x: -45.560, y: 20.350, }; // [0]
const TLS_1: Point = { x: -33.640, y: 9.980 }; // south [1]
...
export function parseSvg(svgInString: string): null | SvgParsedData {
    ...
    if (gcpElements) {
        ...
        return { referencePoints, originOfTSL: referencePoints[0], scale, angle, transformMatrix };
    }
...
export function transformPoint(point: Point, transform: TransformMatrix): Point {
